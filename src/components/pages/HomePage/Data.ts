...
export const footer = {
    about: {
        twitter: 'https://twitter.com/gvisors',
        facebook: 'https://www.facebook.com/gvisors/',
        linkedin: 'https://www.linkedin.com/company/gradvisors/about/',
        instagram: 'https://www.instagram.com/gvisors/',
        medium: 'https://gradvisors.medium.com/',
    },
    quickLinks: [
        [
            {
            ...
            {
                link: 'https://education.gvisors.com/usa',
                name: 'United States',
            },
            {
                link: 'https://education.gvisors.com/uk',
                name: 'United Kingdom',
            },
            {
                link: 'https://education.gvisors.com/canada',
                name: 'Canada',
            },
            {
                link: 'https://education.gvisors.com/australia',
                name: 'Australia',
            },
        ],
        [
            ...
            {
                link: 'https://www.facebook.com/groups/leafatlums',
                name: 'LUMS',
            },
            {
                link: 'https://www.facebook.com/groups/eafiba',
                name: 'IBA',
            },
            {
                link: 'https://www.facebook.com/groups/lseaf',
                name: 'LSE',
            },
        ],
        [
        ...
        [
            ...
            {
                link: 'https://www.instagram.com/ali_aanish',
                name: 'Talk to our CEO',
            },
            {
                link: 'https://education.gvisors.com/ambassador',
                name: 'Join Us',
            },
            {
                link: 'https://octopus.do/zukxfmmiaia',
